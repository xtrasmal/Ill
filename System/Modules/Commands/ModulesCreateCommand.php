...
class ModulesCreateCommand extends AbstractCommand {
	...
	public function fire()
	{
		...
		{
			// Get path to modules
			$modulePath = $this->app['config']->get('ill.path');
            ...
            $this->app['files']->makeDirectory($modulePath . '/cases', 0755);
            $this->app['files']->makeDirectory($modulePath . '/commands', 0755);
            $this->app['files']->makeDirectory($modulePath . '/events', 0755);
            $this->app['files']->makeDirectory($modulePath . '/listeners', 0755);
            $this->app['files']->makeDirectory($modulePath . '/repositories', 0755);
            $this->app['files']->makeDirectory($modulePath . '/validators', 0755);
            $this->app['files']->makeDirectory($modulePath . '/presenters', 0755);
            ...
            $this->app['files']->makeDirectory($modulePath . '/tests', 0755);
